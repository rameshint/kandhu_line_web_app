<?php
$title = 'Firebase MySQL Sync (Realtime Database)';
include('header.php');
?>

<!-- Firebase MySQL Sync Dashboard using Realtime Database -->
<div class="row">
    <div class="col-12">
        <div class="alert alert-info">
            <h5><i class="icon fas fa-info"></i> Firebase Realtime Database Sync</h5>
            This system uses Firebase Realtime Database (no gRPC required) for seamless mobile app integration.
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <button class="btn btn-primary" onclick="syncData('sync_customers')">Sync Customers to Firebase</button>
                <button class="btn btn-primary" onclick="syncData('sync_loans')">Sync Loans to Firebase</button>
                <button class="btn btn-warning" onclick="syncData('sync_collections')">Sync Collections from Firebase</button>
            </div>
        </div>
    </div>
</div>
        ...
        fetch('firebase_sync_handler_realtime.php', {
            ...
            .then(data => {
                ...
                resultDiv.innerHTML = `<div class="result ${className}">
                        <h4>Sync Result (Realtime Database)</h4>
